...
var implementedOperations = []operationExpectation{
	...
	{Path: "/api/v1/agent/drafts", Method: "post", Success: "201", Schema: "WorkflowDraft", Security: "bearerAuth"},
	{Path: "/api/v1/agent/drafts/{draft-id}/validate", Method: "post", Success: "200", Schema: "WorkflowDraft", Security: "bearerAuth"},
	{Path: "/api/v1/agent/drafts/{draft-id}/confirm", Method: "post", Success: "200", Schema: "WorkflowDefinition", Security: "bearerAuth"},
